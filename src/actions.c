...
/*   Updated: 2025/04/24 21:28:01 by gcesar-n         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	eating(t_philo *philo)
{
	...
	while (!sim_stopped(env) && get_time(env) - start_time < env->time_to_eat)
		usleep(200);
}
...
void	sleeping(t_philo *philo)
{
	...
	start_time = get_time(env);
	while (!sim_stopped(env) && get_time(env) - start_time < env->time_to_sleep)
		usleep(200);
}
...
void	thinking(t_philo *philo)
{
	...
	start_time = get_time(env);
	while (!sim_stopped(env) && get_time(env) - start_time < env->time_to_think)
		usleep(200);
}
